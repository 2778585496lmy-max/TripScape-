        ...
        <div class="loginform">
            <div class="left">
                ...
                <div class="alertwords">
                    已有账户,请<router-link to="/login" class="linkfont">点击这里</router-link>。
                </div>
                <div class="back">
            ...
            <div class="right">
                <form action="">
                    ...
                    <p class="password">
                        <input type="password" placeholder="设置您的密码">
                        <ion-icon name="eye-outline"></ion-icon>
                        <a href="#" @click="showRegisterAlert">手机短信验证</a>
                    </p>
                    <p>
                        <input type="button" class="submit" value="立即注册" @click="showRegisterAlert">
                    </p>
                </form>
                <div class="options">
                    <div class="separator">
